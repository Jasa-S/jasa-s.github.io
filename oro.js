(function () {
    ...
    var activeWeatherController = null;
    ...
    function render(place, weather, dateStr) {
        ...
        if (best) {
            bestHtml =
              ...
              + '<p class="best-window-label">Optimal light</p>'
    ...
    function loadFor(place) {
        ...
        if (activeWeatherController) activeWeatherController.abort();
        ...
        activeWeatherController = (typeof AbortController === 'function') ? new AbortController() : null;
        fetchWeather(place.lat, place.lon, activeWeatherController ? activeWeatherController.signal : undefined).then(function (weather) {
